    ...
    <div className="space-y-6">
      <div className="rounded-3xl border border-slate-200 bg-white p-6 md:p-8">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-600">Create, edit, and remove items from your menu.</p>
          </div>
      ...
      {error ? (
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-10 text-center">
          ...
          <p className="mt-2 text-sm text-slate-600">Add your first menu item to start receiving orders.</p>
        </div>
      ) : (
        <div className="grid gap-4">
          {meals.map((m: any) => (
            <div key={m.id} className="rounded-3xl border border-slate-200 bg-white p-5">
              <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                <div className="min-w-0">
                  ...
                  <p className="mt-1 text-xs text-slate-600">
                    ...
                    <span className={m.isAvailable ? "text-emerald-700" : "text-slate-500"}>
